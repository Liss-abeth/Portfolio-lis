    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="bg-gray-900 bg-opacity-50 backdrop-blur-md p-6 sm:p-8 rounded-lg border border-gray-800 shadow-lg">
        ...
        <p className="text-gray-300 mb-6 leading-relaxed">
          I’m a dedicated <span className="text-indigo-300 font-semibold">MERN Stack Developer</span> with practical experience in building dynamic, responsive, and user-friendly web applications. My passion for technology has grown into a career focused on delivering scalable and efficient solutions.
        </p>
        <p className="text-gray-300 leading-relaxed">
          I specialize in full-stack development using <span className="text-indigo-300">MongoDB, Express.js, React.js, and Node.js</span>, building modern, high-performance applications that enhance user experiences.
        </p>
      </div>
...
>
  ...
  <div className="grid gap-10 md:grid-cols-1 lg:grid-cols-2">
    {experienceData.map((exp, index) => (
      ...
      >
      <h3 className="text-base sm:text-lg md:text-xl font-semibold text-indigo-300 mb-2">{exp.role}</h3>
